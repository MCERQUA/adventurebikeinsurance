...
export function CTA({
  ...
  description = "Get a customized insurance quote for your adventure bike in 15 minutes. We shop multiple carriers to find you the best coverage at the best rate.",
